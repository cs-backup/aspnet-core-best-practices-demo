...
export interface IAdminClient {
    getCustomers(): Observable<CustomersListVm>;
}
...
export class AdminClient implements IAdminClient {
    ...
    getCustomers(): Observable<CustomersListVm> {
        let url_ = this.baseUrl + "/api/Admin/GetCustomers";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processGetCustomers(response: HttpResponseBase): Observable<CustomersListVm> {
